...
#include "moc_SimulationViewer.hh"
...
void SimulationViewer::drawWithNames()
{
...
void SimulationViewer::postSelection(const QPoint& point)
{
...
QString SimulationViewer::helpString() const
{
...
(int ac, char** av, void (*onStep)(SimulationViewer*), unsigned int dt)
{
  ...
  viewer->app_->setMainWidget(viewer);
#else
